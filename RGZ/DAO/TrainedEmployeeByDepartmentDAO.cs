...
namespace RGZ.DAO
{
    internal class TrainedEmployeeByDepartmentDAO : AbstractDAO
    {
        private readonly string department = "";

        public TrainedEmployeeByDepartmentDAO() : base()
        {
            Columns.Add("id");
            ...
            Columns["employee_id"].ReadOnly = true;
            Columns["employee_surname"].ReadOnly = true;
            Columns["employee_name"].ReadOnly = true;
            Columns["employee_position"].ReadOnly = true;
            Columns["course_id"].ReadOnly = true;
            Columns["course_name"].ReadOnly = true;
            Columns["course_duration"].ReadOnly = true;
            Columns["course_description"].ReadOnly = true;
            Columns["completion_date"].ReadOnly = true;
        }

        public TrainedEmployeeByDepartmentDAO(string department) : this()
        {
            this.department = department;
        }

        public override string GetQueryString() => $"SELECT * FROM get_trained_employee_by_department('{department}');";
